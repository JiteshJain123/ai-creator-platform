...
const buildTransformationUrl = (src, transformations = []) => {
...
export const transformations = {
  // Smart crop with different focus areas
  smartCrop: (url, width, height, focus = "auto") => {
  ...
  combineTransformations: (url, transformations) => {
